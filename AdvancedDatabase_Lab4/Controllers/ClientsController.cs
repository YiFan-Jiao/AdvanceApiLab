...
namespace AdvancedDatabase_Lab4.Controllers
{
    ...
    {
        private readonly AdvancedDatabase_Lab4Context _context;

        public ClientsController(AdvancedDatabase_Lab4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Client != null ? 
                          ...
                          Problem("Entity set 'AdvancedDatabase_Lab4Context.Client'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabase_Lab4Context.Client'  is null.");
            }
            var client = await _context.Client.FindAsync(id);
            if (client != null)
            {
