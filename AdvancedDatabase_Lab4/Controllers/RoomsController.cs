...
namespace AdvancedDatabase_Lab4.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public RoomsController(AdvancedDatabase_Lab4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Room != null ? 
                          ...
                          Problem("Entity set 'AdvancedDatabase_Lab4Context.Room'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabase_Lab4Context.Room'  is null.");
            }
            var room = await _context.Room.FindAsync(id);
            if (room != null)
            {
